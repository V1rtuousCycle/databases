...
var app = {
  ...
  fetch: function(animate) {
    $.ajax({
      ...
      success: function(data) {
        ...
        app.messages = data;
        console.log('messages client arr', app.messages);
  ...
  init: function() {
    ...
    // app.startSpinner();
    app.fetch(false);//classes/messages

    /*var initMsg ={
      username: "HRR",
      text: "I LOVE WHEN I CAN PRETEND A WEEK IS ACTUALLY 1 DAY LONG",
      //preferedPhrase : "DONT WORRY YOU HAVE A WEEK TO DO THIS ASSIGNMENT",
      roomname: "STACKHANOV LOVERS"
    }


    app.send(JSON.stringify(initMsg)); */
